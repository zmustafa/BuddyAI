...
public partial class OpenAiImportForm : Form
{
    ...
    public OpenAiImportForm()
    {
        Text = "Import OpenAI API Key";
        ...
        {
            Text = "1. Log in & Create new secret key.  2. Paste here:",
        ...
        Load += async (s, e) =>
        {
            try
            {
                ...
                _webView.CoreWebView2.Navigate("https://platform.openai.com/api-keys");
            }
            catch (Exception ex)
            {
