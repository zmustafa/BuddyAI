...
public partial class GeminiImportForm : Form
{
    ...
    public GeminiImportForm()
    {
        Text = "Import Google Gemini API Key";
        ...
        Load += async (s, e) =>
        {
            try
            {
                ...
                _webView.CoreWebView2.Navigate("https://aistudio.google.com/app/apikey");
            }
            catch (Exception ex)
            {
